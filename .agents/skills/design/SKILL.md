---
name: design
description: Diseño frontend para Sixteam.pro con React, Tailwind CSS y shadcn/ui. Usar cuando se pida crear o mejorar componentes, páginas, layouts o interfaces. Genera código production-ready con la estética y stack del proyecto.
argument-hint: [qué componente o página diseñar]
---
...
Usa siempre los colores, fuentes y estilo de `/brand`. Consulta brand guidelines si hay dudas.

### 3. Estructura mobile-first
```
// Orden de breakpoints siempre así:
...
Usa las animaciones ya definidas en `index.css`. Para nuevas, sigue este estilo:
```css
/* Sutiles, funcionales, sin exagerar */
