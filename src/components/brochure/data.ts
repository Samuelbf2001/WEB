...
export const PRODUCTS: {
...
}[] = [
  {
    name: 'Ops Esencial',
    accent: '#1d70a2',
    ideal: 'Activa un agente IA y empieza a operar tecnología sin grandes inversiones.',
    includes: [
      '60 créditos mensuales',
      '1 agente IA activo',
      'Plataforma CRM incluida',
  ...
  },
  {
    ...
    accent: '#00bfa5',
    badge: 'Más elegido',
    ideal: 'Operación multi-canal con más créditos, integraciones y automatizaciones avanzadas.',
    includes: [
      '160 créditos mensuales',
      'Agentes IA en CRM, WhatsApp y email',
  ...
  },
  {
    name: 'Ops Total',
    accent: '#7de8d8',
    ideal: 'Capacidad dedicada para operaciones de mayor volumen con PM y equipo completo.',
    includes: [
