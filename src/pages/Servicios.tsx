...
const Servicios = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      tag: 'Atención',
      title: 'CRM para Atención al Cliente',
    ...
    },
    {
      ...
      price: '$1.000.000 COP implementación',
      time: '2–3 semanas',
      ...
      deliverables: [
        ...
        'Soporte mensual desde $300.000 COP/mes',
      ],
