...
PRECIO: Desde $1,500 USD por proyecto Transform, o incluido dentro de un plan Ops mensual según alcance.
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                <div className="flex items-center gap-2 bg-white/10 rounded-lg px-4 py-2">
                  ...
                  <span className="text-white font-semibold">Desde $1,500 USD por proyecto</span>
                </div>
                <div className="flex items-center gap-2 bg-white/10 rounded-lg px-4 py-2">
