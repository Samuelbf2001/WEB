        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-[#0a2342] rounded-2xl p-8 text-white">
              ...
              <div className="text-4xl font-bold text-blue-400 mb-1">Desde $1,500 USD</div>
              <p className="text-gray-300 text-sm mb-6">Proyecto Transform a cotizar según alcance</p>
