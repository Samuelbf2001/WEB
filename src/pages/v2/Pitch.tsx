...
const plans = [
  {
    ...
    price: "$1,500",
    period: "/mes",
    target: "Empresas $300K–$1M ARR",
    features: ["1 frente de operación", "IA esencial", "Dashboard de revenue", "Cadencia mensual"],
    best: false,
  },
  {
    name: "CORE",
    price: "$3,000",
    period: "/mes",
    target: "Empresas $1M–$3M ARR",
    features: ["3 frentes (3× capacidad)", "Multi-canal", "Cadencia semanal", "WhatsApp diario", "Reajuste continuo"],
    best: true,
  },
  {
    name: "PLUS",
    price: "$5,500",
    period: "/mes",
    target: "Empresas $3M–$8M ARR",
    features: ["5 frentes de operación", "PM dedicado", "Llamada semanal", "Expansión de playbooks", "Acceso a todo el equipo IA"],
    best: false,
  },
];
